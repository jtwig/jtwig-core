...
public class RenderContext {
    ...
    private final StackedContext<ContextItem<ResourceReference>> resourceContext;
    ...
    public StackedContext<ContextItem<ResourceReference>> getResourceContext() {
