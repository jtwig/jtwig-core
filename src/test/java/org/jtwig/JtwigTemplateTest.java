...
public class JtwigTemplateTest {
    ...
    public void classpathLocation() throws Exception {
        expectedException.expectMessage(containsString("Classpath resource 'classpath:/test' not found"));

        JtwigTemplate.classpathTemplate("/test", configuration().build());
    }
    ...
    public void classpathLocation2() throws Exception {
        ...
        JtwigTemplate.classpathTemplate("classpath:/test", configuration().build());
    }
