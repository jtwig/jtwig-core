...
public class SubtractOperationCalculatorTest {
    ...
    public void subtract() throws Exception {
        ...
        when(leftOperand.calculate(renderContext)).thenReturn(JtwigValueFactory.value(new BigDecimal("2.3"), VALUE_ENVIRONMENT));
        when(rightOperand.calculate(renderContext)).thenReturn(JtwigValueFactory.value(new BigDecimal("1.3"), VALUE_ENVIRONMENT));
