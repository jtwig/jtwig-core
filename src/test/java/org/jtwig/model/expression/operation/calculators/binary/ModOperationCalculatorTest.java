...
public class ModOperationCalculatorTest {
    ...
    public void mod() throws Exception {
        ...
        when(leftOperand.calculate(renderContext)).thenReturn(JtwigValueFactory.create(new BigDecimal("11")));
        when(rightOperand.calculate(renderContext)).thenReturn(JtwigValueFactory.create(new BigDecimal("2")));
