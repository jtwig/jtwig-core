...
public class ModOperationCalculatorTest {
    ...
    public void mod() throws Exception {
        ...
        when(leftOperand.calculate(renderContext)).thenReturn(JtwigValueFactory.value(new BigDecimal("11"), new DefaultValueConfiguration()));
        when(rightOperand.calculate(renderContext)).thenReturn(JtwigValueFactory.value(new BigDecimal("2"), new DefaultValueConfiguration()));
