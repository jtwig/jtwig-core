...
public class ModOperationCalculatorTest {
    ...
    public void mod() throws Exception {
        ...
        when(leftOperand.calculate(renderContext)).thenReturn(JtwigValueFactory.value(new BigDecimal("11"), NamedValueConfiguration.COMPATIBLE_MODE));
        when(rightOperand.calculate(renderContext)).thenReturn(JtwigValueFactory.value(new BigDecimal("2"), NamedValueConfiguration.COMPATIBLE_MODE));
