...
public class BlockFunctionTest extends AbstractIntegrationTest {
    ...
    public void block() throws Exception {
        String result = defaultStringTemplate("{% block one %}Hello{% endblock %}{{ block('one') }}")
    ...
    public void blockWithExtends() throws Exception {
        String result = defaultStringTemplate("{% extends 'a' %}{% block one %}a{% endblock %}", configuration()
